...
public class GoalDaoImpl extends BaseDao implements GoalDao {
	...
	public List<Map<String, Object>> findGoalList() {
		String sql = "select t.goal_name,sum(t.stage_cost_hours) as goal_cost_hours,floor(sum(t.stage_cost_hours*t.progress)/sum(t.stage_cost_hours)) as goal_process from my_goal t GROUP BY t.goal_name";
